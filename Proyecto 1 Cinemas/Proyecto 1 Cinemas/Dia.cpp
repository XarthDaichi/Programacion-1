...
// Metodo para cambiar de numero de dia a fecha (mes-dia-annio)
string Dia::DiaAFecha(int d, int an) {
	...
	if (an % 4 == 0 && an % 100 == 0 && an % 400 == 0) {
		...
		if (d <= 31) {
			...
			s << "Septiembre " << d - 243 << ", " << an;
		}
		else if (d <= 304) {
			s << "Octubre " << d - 273 << ", " << an;
		}
		else if (d <= 334) {
			s << "Noviembre " << d - 304 << ", " << an;
		}
		else if (d <= 365) {
			s << "Diciembre " << d - 334 << ", " << an;
		}
	}
	s << endl;
	return s.str();
		...
		if (vec[i]->getFuncion() != NULL) {
			...
			if (annio % 4 == 0 && annio % 100 == 0 && annio % 400 == 0) {
				...
				if (dia <= 31) {
					...
					s << "Marzo " << dia - 59 << ", " << annio;
				}
				else if (dia <= 120) {
					s << "Abril " << dia - 90 << ", " << annio;
				}
				else if (dia <= 151) {
					s << "Mayo " << dia - 120 << ", " << annio;
				}
				else if (dia <= 181) {
					s << "Junio " << dia - 151 << ", " << annio;
				}
				else if (dia <= 212) {
					s << "Julio " << dia - 181 << ", " << annio;
				}
				else if (dia <= 243) {
					s << "Agosto " << dia - 212 << ", " << annio;
				}
				else if (dia <= 273) {
					s << "Septiembre " << dia - 243 << ", " << annio;
				}
				else if (dia <= 304) {
					s << "Octubre " << dia - 273 << ", " << annio;
				}
				else if (dia <= 334) {
					s << "Noviembre " << dia - 304 << ", " << annio;
				}
				else if (dia <= 365) {
					s << "Diciembre " << dia - 334 << ", " << annio;
				}
			}
			s << endl << endl;
		}
