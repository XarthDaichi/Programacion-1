#include "Cinema.h"
/* 
* Programador: Diego Quiros Artinano
* Fecha: 10 de octubre, 2021
* Objetivo: Hacer un programa con el que se pueda comprar tiquetes de cine
*			imprimiendo la informacion del cine y la matriz de asientos
*/


int main() {
	// Variables temporales para los atributos de las clases
		...
		case 3:
			...
			if (tempNum <= 7 && tempNum >= 1) {
				...
				if (tempNum2 >= 1 && tempNum2 <= Cine.getCantPosible()) {
					...
					cout << "El monto seria: " << pagar << " colones" << endl << endl;
					if (pagar != 0) {
						...
						if (deseo1 == 1) {
							...
							cout << "Tiene que pagar: " << pagar << " colones" << endl << endl;
							Cine.devolverAsientos();
						}
					}
				}
